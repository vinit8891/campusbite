export const ROUTES = {
  ...
  SUBSCRIPTIONS_PASS: "/subscriptions/pass",
  ABOUT: "/about",
  CONTACT: "/contact",
  TERMS: "/terms",
  ...
  RESTAURANT_COUNTER: "/restaurant/dashboard/counter",
...
export const routes = {
  ...
  subscriptionsPass: ROUTES.SUBSCRIPTIONS_PASS,
  about: ROUTES.ABOUT,
  ...
  restaurant: {
    ...
    counter: ROUTES.RESTAURANT_COUNTER,
